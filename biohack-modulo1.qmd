...
-   Toda la información del curso está disponible en [su página web](https://mmorenozam.github.io/biohack_progR/){target="_blank"}
...
-   Amplio abanico de paquetes/librerías (22313 al 12.04.2025).
...
-   En la medida de lo posible, es preferible evitar contener espacios vacíos en los nombres ya sea de objetos dentro de R o de columnas a importar de una tabla. En lugar de espacios, podemos usar `_` ó `-`.

-   Sin embargo, mediante sintaxis especial, es posible tener espacios vacíos:
...
-   Y por supuesto, inteligencia artificial (ChatGPT, deepseek, etc).
:::
...
::: {.title data-id="title"}
[Ejercicios 1.1](https://mmorenozam.github.io/biohack_progR/ejercicios_m1.html#ejercicios-1.1){target="_blank"}
:::


:::{.timer #Timer1 seconds=150 starton=interaction}
:::
...
## Creación de factores {visibility="uncounted" .smaller}
...
Si tuviésemos muchos niveles del factor, y solo estamos interesados en que uno de ellos sea la referencia:

```{r echo=T, eval=T, error=T}
#| include: true
variable_factor_2 <- c("Tr.A", "Tr.A", "Tr.B", "Control", "Control", "Control")
variable_factor_2 <- relevel(factor(variable_factor_2), ref = "Tr.A")
str(variable_factor_2)
```
...
::: {.title data-id="title"}
[Ejercicios 1.2](https://mmorenozam.github.io/biohack_progR/ejercicios_m1.html#ejercicios-1.2){target="_blank"}
:::

:::{.timer #Timer2 seconds=240 starton=interaction}
:::
...
::: {.title data-id="title"}
[Ejercicios 1.3](https://mmorenozam.github.io/biohack_progR/ejercicios_m1.html#ejercicios-1.3){target="_blank"}
:::


:::{.timer #Timer3 seconds=150 starton=interaction}
:::
...
Portada por <a href="https://unsplash.com/@becomes?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Becomes Co</a> en <a href="https://unsplash.com/photos/2-men-sitting-on-black-office-rolling-chairs-s_FHDDSVp1s?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Unsplash</a>

Foto final por <a href="https://unsplash.com/@wolfgang_hasselmann?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Wolfgang Hasselmann</a> en <a href="https://unsplash.com/photos/dandelion-flower-under-golden-hour-Kovuf0yU8NU?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Unsplash</a>
...
![](images/wolfgang-hasselmann-Kovuf0yU8NU-unsplash.jpg){.image-right}
